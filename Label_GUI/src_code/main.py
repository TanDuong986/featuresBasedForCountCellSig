...
"}")
        ...
        self.gridLayout_10.addWidget(self.frame_10, 1, 2, 1, 1)
        ...
        self.configuration = QtWidgets.QFrame(self.frame_8)
        ...
        self.gridLayout.addWidget(self.configuration, 0, 0, 2, 1)
